...
document.addEventListener("DOMContentLoaded", () => {
  ...
  (() => {
    ...
    // iOS-friendly scroll lock (prevents background scroll but keeps modal scrollable)
    let __pmScrollY = 0;
    function lockBodyScroll(){
      __pmScrollY = window.scrollY || document.documentElement.scrollTop || 0;
      document.body.dataset.pmScrollY = String(__pmScrollY);
      document.body.style.position = "fixed";
      document.body.style.top = `-${__pmScrollY}px`;
    ...
    function unlockBodyScroll(){
      const y = parseInt(document.body.dataset.pmScrollY || "0", 10) || 0;
      delete document.body.dataset.pmScrollY;
